!function(){function e(e){null==e&&(e=require("jsdom").jsdom().createWindow(),e.XMLHttpRequest=require("xmlhttprequest").XMLHttpRequest,e.XMLHttpRequest.prototype.withCredentials=!1,null==e.location&&(e.location=require("location")),null==e.navigator&&(e.navigator=require("navigator")));e.location,e.navigator,e.XMLHttpRequest;/*!
